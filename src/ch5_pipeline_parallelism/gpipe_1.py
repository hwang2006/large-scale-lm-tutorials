...
if __name__ == "__main__":
    ...
    data_loader = DataLoader(
       tokenized_datasets["train"], shuffle=False, batch_size=batch_size, collate_fn=data_collator, num_workers=8
    )
    ...
    for i, data in enumerate(data_loader):
        ...
        input_ids = data.input_ids.to(0)
        labels = data.input_ids.to(world_size - 1)
