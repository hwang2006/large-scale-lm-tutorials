...
def batch_fn(data):
    input_ids = data
    labels = data
    #print(f"rank:{rank}, data:{data.shape}")
...
def loss_fn(logits, labels):
    ...
    #print(f"loss_fn is called at {rank}, logits.shape : {logits.shape}, loss: {loss}")
    return loss
...
if __name__ == "__main__":
    ...
    engine, optimizer, _, _ = deepspeed.initialize(
        ...
        config={
            ...
            "gradient_accumulation_steps" : int(batch_size / world_size),
